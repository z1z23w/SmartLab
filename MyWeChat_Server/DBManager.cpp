...
bool DBManager::deleteFriend(int, const QString &)
{
    return false;
}
bool DBManager::updateFriendRemark(int, const QString &, const QString &)
{
    return false;
}
void DBManager::updateUserStatus(int, bool, QString, int) {}
