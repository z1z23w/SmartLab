...
Q_CONSTINIT const QMetaObject MediaSessionController::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN22MediaSessionControllerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MediaSessionController, std::true_type>,
        // method 'mediaStreamGenerated'
...
void MediaSessionController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (MediaSessionController::*)(QByteArray );
            if (_q_method_type _q_method = &MediaSessionController::mediaStreamGenerated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
